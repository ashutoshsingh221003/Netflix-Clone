...
//snapshot is like taking a snap or the picture of url of database at that current time 
...
{movies.map((item, id) => (
   <div key={id} className='w-[160px] sm:w-[200px] md:w-[240px] lg:w-[280px] inline-block curser-pointer relative p-2'>
